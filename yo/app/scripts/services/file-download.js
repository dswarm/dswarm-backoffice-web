...
angular.module('dmpApp')
    ...
    .factory('mobileBrowserCheck', function($window) {
        // http://detectmobilebrowsers.com/
        var ua = $window.navigator.userAgent || $window.navigator.vendor || $window.window.opera;
    ...
    .factory('fileDownload', function($window, mobileBrowserCheck) {
        ...
        function onAndroid(fileUrl) {
            return onIos(fileUrl);
        }
        ...
        function fileDownload(fileUrl) {
            if (!mobileBrowserCheck.mobile) {
                onDesktop(fileUrl);
            } else if (mobileBrowserCheck.ios) {
                onIos(fileUrl);
            } else if (mobileBrowserCheck.android) {
                onAndroid(fileUrl);
            } else if (mobileBrowserCheck.other) {
                onMobile(fileUrl);
            }
        }
